...
public class Login {
    ...
    @Expose
    public List<UserPurchase> userPurchase = null;
    ...
    public class UserPurchase {
        ...
        public UserPurchase withId(String id) {
            this.id = id;
            return this;
        }

        public UserPurchase withUserid(String userid) {
            this.userid = userid;
            return this;
        }

        public UserPurchase withPurchasekey(String purchasekey) {
            this.purchasekey = purchasekey;
            return this;
        }

        public UserPurchase withCreatedate(String createdate) {
            this.createdate = createdate;
            return this;
        }

        public UserPurchase withExpirydate(String expirydate) {
