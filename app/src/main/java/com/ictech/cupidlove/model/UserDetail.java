...
public class UserDetail {
    ...
    public UserDetail withMessage(String message) {
        this.message = message;
        return this;
    }

    public UserDetail withError(boolean error) {
        this.error = error;
        return this;
    }

    public UserDetail withBody(Body body) {
        this.body = body;
        return this;
    }
    ...
    public class Body {
        ...
        @SerializedName("ethnicity_pref")
        @Expose
        public String ethnicityPref;

        @SerializedName("religion_pref")
        @Expose
        public String religionPref;
        ...
        public Body withFbId(Object fbId) {
            this.fbId = fbId;
            return this;
        }
