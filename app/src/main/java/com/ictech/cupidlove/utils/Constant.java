...
public class Constant {
    ...
    public static  String SKUCHAT = "";

    public static  String TESTSKU = "";

    public static  String SKULOCATION = "";

    public static  String SKUSPERLIKE = "";

    public static  String SKUREMOVEAD = "";
    ...
    public static final String MyPREFERENCES = "com.ictech.cupidlove"; // Set Your Package Here

    public static final String PACKAGE_NAME = "com.ictech.cupidlove";// Set Your Package Here
