...
public abstract class PurchaseSuperLike extends BlundellActivity implements IabHelper.OnIabSetupFinishedListener, IabHelper.OnIabPurchaseFinishedListener {
    ...
    protected void purchaseItem(String sku) {
        billingHelper.launchPurchaseFlow(this, sku, 125, this);
    }
    ...
    public void onIabPurchaseFinished(IabResult result, Purchase info) {
        ...
        } else if (Constant.TESTSKU.equals(info.getSku())) {
    ...
    protected void dealWithPurchaseFailed(IabResult result) {
        Prefs.putBoolean(RequestParamUtils.ALLOWSUPERLIKEINAPPPURCHASE, false);
