package com.ictech.cupidlove.helper;
...
public class InstagramApp {
    ...
    public static InstaLoginActivity.OAuthDialogListener listener;
    ...
    public InstagramApp(Context context, String clientId, String clientSecret,
        ...
        if (mAccessToken != null) {
            ...
            listener = new InstaLoginActivity.OAuthDialogListener() {
                @Override
                public void onComplete(String code) {
                    Log.e("OAuthDialogListener", "OAuthDialogListener");
                    getAccessToken(code);
                    Log.e("", "");
                }
            ...
            Intent intent = new Intent(context, InstaLoginActivity.class);
            intent.putExtra("mAuthUrl", mAuthUrl);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.e(TAG, "Got name: " + name + ", bio [" + bio + "]");
                } catch (Exception ex) {
                    what = WHAT_ERROR;
                    ex.printStackTrace();
                }
