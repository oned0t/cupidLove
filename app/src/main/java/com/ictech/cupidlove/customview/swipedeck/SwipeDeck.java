...
import com.ictech.cupidlove.customview.swipedeck.Utility.Deck;
...
public class SwipeDeck extends FrameLayout {
    ...
    public void swipeTopCardLeft(int duration) {
        deck.get(0).getCard().findViewById(leftImageResource).setAlpha(1);
        deck.get(0).getCard().findViewById(leftImageResource).setVisibility(VISIBLE);
        if (deck.size() > 0) {
    ...
    public void swipeTopCardRight(int duration) {
        deck.get(0).getCard().findViewById(rightImageResource).setAlpha(1);
        deck.get(0).getCard().findViewById(rightImageResource).setVisibility(VISIBLE);
        if (deck.size() > 0) {
    ...
    public void swipeTopCardTop(int duration) {
        deck.get(0).getCard().findViewById(topImageResource).setAlpha(1);
        deck.get(0).getCard().findViewById(topImageResource).setVisibility(VISIBLE);
        if (deck.size() > 0) {
