package com.ictech.cupidlove.customview.rangeseekbar.interfaces.widgets;
...
import com.ictech.cupidlove.customview.rangeseekbar.interfaces.OnSeekbarChangeListener;
import com.ictech.cupidlove.customview.rangeseekbar.interfaces.OnSeekbarFinalValueListener;
...
public class CrystalSeekbar extends View {
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        // TODO : prevent render is in edit mode
        if (isInEditMode()) return;

        // TODO : setup bar
        setupBar(canvas, _paint, _rect);

        // TODO : setup seek bar active range line
        setupHighlightBar(canvas, _paint, _rect);

        // TODO : draw left thumb
