...
public class SwipeDeckAdapter extends BaseAdapter implements OnItemClickListner, ResponseListener {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        FrameLayout flMutualFriends = v.findViewById(R.id.flMutualFriends);
//        ImageView img_report_user = (ImageView) v.findViewById(R.id.img_report_user);
        TextViewRegular tvNameAge = v.findViewById(R.id.tvNameAge);
        TextViewRegular tvLocationName = v.findViewById(R.id.tvLocationName);
        TextViewRegular tvCollage = v.findViewById(R.id.tvCollage);
        TextViewRegular tvProfession = v.findViewById(R.id.tvProfession);
        TextViewRegular tvMutualFriendCount = v.findViewById(R.id.tvMutualFriendCount);
        FrameLayout flReportUser = v.findViewById(R.id.flReportUser);
        countDotId = v.findViewById(R.id.countDotId);
