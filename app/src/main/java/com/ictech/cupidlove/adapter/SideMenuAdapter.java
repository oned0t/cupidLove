...
public class SideMenuAdapter extends BaseAdapter {
    ...
    private int intImages[] = {R.drawable.ic_play, R.drawable.ic_send_message, R.drawable.ic_notification, R.drawable.profile,
           R.drawable.ic_settings, R.drawable.ic_location_white, R.drawable.remove_ad};

    public SideMenuAdapter(Context context) {
        this.context = context;
        inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        String in_app_purchase = Prefs.getString(Config.PAID_AD, "OFF");
        if (in_app_purchase != null && !in_app_purchase.isEmpty() && !in_app_purchase.equals("OFF")) {
            if (Prefs.getBoolean(RequestParamUtils.ADENABLED, false)) {
                list = Arrays.asList(
