...
public class PlacesAdapter extends RecyclerView.Adapter<PlacesAdapter.RecentViewHolder> {
    ...
    public PlacesAdapter(Activity activity, OnItemClickListner onItemClickListner) {
...
//        holder.ratingBar1.setRating(list.get(position).rating);
