...
public class ShowEthnicityAdapter extends RecyclerView.Adapter<ShowEthnicityAdapter.CategoryGridHolder> {
    ...
    public ShowEthnicityAdapter(Activity activity, OnItemClickListner onItemClickListner) {
